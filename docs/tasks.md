...
- [x] Create management command directory structure at `core/management/commands/`
- [x] Implement smart dummy data seeding management command in `core/management/commands/seed_data.py` supporting separate `--scenario` loads
- [x] Create documentation and example guide at `examples/README.md` walkthrough for demoing the scenarios
- [x] Add unit tests in `core/tests.py` to verify seeder functionality and data validation compliance
- [x] Run the test suite and verify all test cases pass
